...
uses UnitPrincipal, UnitEsqueciMinhaSenha;
...
begin
      if NOT Assigned(FrmEsqueciMinhaSenha) then
          Application.CreateForm(TFrmEsqueciMinhaSenha, FrmEsqueciMinhaSenha);
...
begin
      if cb_termos.IsChecked = true then
      begin
            ActFoto.Execute;
      end
      else if cb_termos.IsChecked = false then
      begin
            lbl_nao_aceitou_termos.Visible := true;
      end;
end;
